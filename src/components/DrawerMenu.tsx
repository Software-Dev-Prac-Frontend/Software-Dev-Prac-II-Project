    ...
    <Drawer anchor="left" open={open} onClose={toggleDrawer}>
        <Box sx={{ width: 250, height: "100%", display: "flex", flexDirection: "column", marginTop: 4}} role="presentation" onClick={toggleDrawer} onKeyDown={toggleDrawer}>
            <List>
                ...
                <ListItem component="button" onClick={() => router.push("/myreservation")}>
                    <ListItemText primary="My Reservation" />
                </ListItem>
                <ListItem component="button" onClick={() => router.push("/reservation")}>
            ...
            <List sx={{ marginTop: "auto" }}>
                {(!login ?
                    <ListItem component="button" onClick={() => router.push("/login")}>
